...
/*   Updated: 2025/12/02 14:08:13 by aelbouaz         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*philo_routine(void *arg)
{
	...
	{
		pthread_mutex_lock(&ph->vars->printf_mtx);
		printf("last philo's id is %ld\n", ph->id);
		pthread_mutex_unlock(&ph->vars->printf_mtx);
